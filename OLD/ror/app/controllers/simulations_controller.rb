class SimulationsController < ApplicationController
  ...
  def create
    simulation_params[:at]=Date.parse(simulation_params[:at])
  ...
  private
    ...
    def simulation_params
      params.require(:simulation).permit(:at, :totalValue, :rate, :years, :monthlyCost, :totalCost, :monthlytotalCost, :costRate)
    end
end
